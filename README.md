...
The website is a single-page application (SPA) that allows smooth navigation through different sections including About Me, Resume, Skills, Languages, Extra Activities, References, and Contact.
...
- Contact form with PHP email validation
